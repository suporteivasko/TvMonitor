    ...
    <div className="streaming">
      {isChecked && isInitialized && (
        <ReactPlayer
          ...
          className="video"
          volume={0}
          config={{ youtube: { playerVars: { rel: 0, fs:1 } } }}
          width={'100%'} // Definir a largura como 100% para preencher o contêiner
          height={'100%'} // Definir a altura como 100% para preencher o contêiner
          style={{ objectFit: 'contain' }} // Ajustar o estilo do vídeo para preencher o contêiner mantendo a proporção
